...
@Component({
  selector: 'app-tax',
  standalone: true,
  imports: [NavbarComponent,NgFor,MatSlideToggleModule,DeleteTaxComponent,AddButtonComponent,AddTaxTypeComponent,MatButtonModule, MatBottomSheetModule],
...
export class TaxComponent {
 taxes :any[]=[]
  ...
  constructor(private taxService: TaxService, private _bottomSheet: MatBottomSheet) {}
